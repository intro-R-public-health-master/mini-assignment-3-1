...
**Due Monday, October 11 at the end of class through Github**
...
This is the raw clicker data from last year's PH Biostats chocolate experiment that was eventually processed to provide the data for last year's Module 3 project.  Click on the file and select "View File" to see what's in the file. All variables are text values but missing values in this file are designated with `NV`.
```{r}
# with default settings
